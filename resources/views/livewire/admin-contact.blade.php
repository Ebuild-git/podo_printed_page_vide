<div>
    ...
    <div class="card mb-8">
        ...
        <form class="card-body" wire:submit="update_form" enctype="multipart/form-data">
            ...
            <div class="row g-6">
                <div class="col-md-3">
                    <label class="form-label" for="multicol-first-name">Utisateurs</label>
                ...
                <div class="col-md-3">
                    <label class="form-label" for="multicol-first-name">Nombre de Docteurs</label>
                    <input type="text"wire:model="coach" id="multicol-last-name" class="form-control"
                        placeholder="Docteurs" />
                    @error('coach')
                        <span class="text-danger small"> {{ $message }} </span>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    <label class="form-label" for="multicol-first-name">Actualités</label>
                ...
                <div class="col-md-3">
                    <label class="form-label" for="multicol-first-name">Succès</label>
